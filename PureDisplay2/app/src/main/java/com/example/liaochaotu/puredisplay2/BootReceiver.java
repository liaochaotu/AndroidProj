...
public class BootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
         //if(intent.equals(Intent.ACTION_BOOT_COMPLETED)){
           //  Intent intent1=new Intent(this,PureDisplayService.class);
          //  context.startService(PureDisplayService.class);
        // }
        Log.d("liaocahotu","PureDisplayService-onReceive");
        Intent intent1 = intent.setClass(context, PureDisplayService.class);
